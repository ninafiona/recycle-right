...
try:
    ...
    img_size = 128
    num_channels = 3
    train_path=r'C:\\Users\\Grabka\\Google Drive\\Hackathon\\NeuralNet\\Approach_3\\data\\train'
    ...
    def train(num_iteration):
        ...
        for i in range(total_iterations,
            ...
            if i % int(data.train.num_examples/batch_size) == 0: 
                ...
                saver.save(session, 'C:\\Users\\Grabka\\Google Drive\\Hackathon\\NeuralNet\\Approach_3\\models\\trained_model') 
